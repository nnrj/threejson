...
<script type="importmap">
{
  "imports": {
    ...
    "threejson/runtime": "https://esm.sh/threejson@0.1.0-alpha.11/runtime"
  }
}
</script>
```
...
<head>
  ...
  <script type="importmap">
  {
    "imports": {
      "three": "https://esm.sh/three@0.184.0",
      "threejson": "https://esm.sh/threejson@0.1.0-alpha.11"
    }
  }
  </script>
</head>
...
await createJsonScene(sceneJson, {
  canvas,
  assetsBase: "https://cdn.jsdelivr.net/npm/@threejson/assets@1.1.6",
  assetsBaseMode: "cdn-first"
});
```
