...
- [Capabilities, Particle V2, and WebGPU/TSL](./capabilities-webgpu-particles.md): machine-readable capability truth, Physical materials, particles, optional WebGPU, TSL security, LOD, curves, and morph targets.
