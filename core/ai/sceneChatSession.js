...
function buildExecutionModePolicyRules(sceneGenerationMode) {
  ...
  return [
    ...
    '- Direct versus draft_refine is independent of geometry representation. A direct vehicle scene may still require a curved editableMesh/loft/NURBS/bufferMesh body shell; "direct" never means "build everything from primitive boxes".',
    ...
    ...(configuredComplexModelStrategy === "full-coordinates"
      ...
      : configuredComplexModelStrategy === "progressive"
        ...
        : [
            ...
            '- The object category itself can establish geometry need even without adjectives. A requested car/automobile should normally use a free-form curved body and cabin shell (editableMesh/subdivision, loft/NURBS, or bufferMesh), while retaining primitives/native geometry for truly regular wheels, axles, lamps, and similar parts. Apply the same mixed-representation reasoning to other subjects with characteristic curved silhouettes.',
