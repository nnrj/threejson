...
- Particles / stars / dust / sparks / smoke / fire / fireworks / visible solar halo → objectList objType particleEmitter. Use source {type:"shell",radius,thickness} for halos, {type:"sphere",radius} for volume dust, curve/meshSurface for shaped flows, and textMask/imageMask for requested particle text or silhouettes. Choose simulation.backend only from the runtime capability snapshot.
...
ParticleEmitterItem: { "objType":"particleEmitter", "source":{"type":"positions"|"box"|"sphere"|"shell"|"disc"|"cone"|"line"|"curve"|"meshSurface"|"textMask"|"imageMask",...}, "emission":{"mode":"static"|"continuous"|"burst","count":number,"rate"?:number,"duration"?:number,"loop"?:boolean,"seed"?:number}, "particle":{"lifetime":number|[min,max]|{"min":number,"max":number},"velocity"?:{x,y,z}|{"min":{...},"max":{...}},"rotation"?:number|[min,max],"sizeOverLife"?:[],"colorOverLife"?:[],"opacityOverLife"?:[]}, "simulation":{"backend":"cpu"|"webgl-compute"|"webgpu-compute" (only if listed in runtime snapshot),"gravity"?:{...},"drag"?:number,"noise"?:{},"attractors"?:[],"boundary"?:{"type":"none"|"wrap"|"bounce"|"kill",...}}, "render":{"type":"points"|"billboard","size"?:number,"color"?:"#RRGGBB","opacity"?:number,"sprite"?:{},"atlas"?:{},"blending"?:"additive","depthWrite"?:false}, "position"?:{...} }
