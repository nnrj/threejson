...
const SIGNAL_TO_SECTIONS = {
  ...
  tslCode: ["webgpu-tsl"],
  complexMesh: ["complex-modeling"],
  editableMesh: ["complex-modeling"],
  rawBufferMesh: ["complex-modeling"],
  subdivisionSurface: ["complex-modeling"],
  parametricSurface: ["complex-modeling"],
  implicitSurface: ["complex-modeling"],
  meshModeling: ["complex-modeling"],
  meshMorph: ["complex-modeling"],
...
const SIGNAL_TO_EXAMPLE_IDS = {
  ...
  complexMesh: ["editable-lounge-chair", "editable-animal-form"],
  editableMesh: ["editable-lounge-chair", "editable-animal-form"],
  rawBufferMesh: ["raw-buffer-morph"],
  subdivisionSurface: ["editable-animal-form"],
  parametricSurface: ["nurbs-freeform-product", "loft-vehicle-shell"],
  implicitSurface: ["implicit-asymmetric-organic", "implicit-humanoid"],
  meshModeling: ["editable-lounge-chair"],
  meshMorph: ["raw-buffer-morph"],
