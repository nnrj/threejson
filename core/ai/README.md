...
完整说明见 [`core/ai/SKILL.md`](./SKILL.md)、[`doc/json-format.md`](../../doc/json-format.md)、[`doc/extensions.md`](../../doc/extensions.md)、[`doc/glossary.md`](../../doc/glossary.md)。能力 gap 归档：[`lab/archive/ai-skill-gap-matrix.md`](../../lab/archive/ai-skill-gap-matrix.md)。

更多演示见 `doc/demos.md`（[`examples/html-demo/track-05-tooling/05-01-ai-scene.html`](../examples/html-demo/track-05-tooling/05-01-ai-scene.html)、`ai-scene.html`、`examples/script/ai-update-scene.mjs`）。
