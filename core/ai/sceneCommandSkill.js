...
function buildCommandAdvancedCapabilityFragment(options = {}) {
  ...
  if (complexMeshSelected) {
    ...
    blocks.push([
      ...
      "- Choose representation per semantic part. For a car, cylinders/torus/native geometry may faithfully express wheels and axles, but the characteristic body/cabin shell should remain a continuous editable/subdivision, loft/NURBS, or buffer surface rather than a stack of boxes.",
