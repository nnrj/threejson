/** Pure deterministic control-mesh evaluation; no runtime, material or registry imports. */
import * as THREE from "three";
import { validateBufferMeshStats } from "../builder/bufferMeshLimits.js";
import { buildTopologyIndexes, normalizeEditableMeshTopology, triangulateEditableFace, validateEditableMeshTopology } from "../builder/editableMesh/editableMeshTopology.js";
import { applyEditableMeshModifiers } from "../builder/editableMesh/editableMeshModifiers.js";
 ...
 */
export function evaluateEditableMeshGeometry(record = {}, options = {}) {
  let sourceTopology;
  let evaluated;
