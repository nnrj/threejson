...
| 编辑器 · 材质槽 | S 下拉 +「高级设置」Modal +「当前生效」摘要：host [`sceneTreeMaterialTree.js`](../tools/scene-host/editor/js/sceneTreeMaterialTree.js) + [`scene-editor.html`](../tools/old_version/scene-editor.html) 内联镜像 |
