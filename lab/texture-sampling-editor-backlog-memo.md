...
| 用户文档 | [doc/json-format.md](../doc/json-format.md)（采样字段节）、[doc/api.md](../doc/api.md)（`textureSampling.js`） |

与 [`doc/scope.md`](../doc/scope.md) 的 Core 承诺区分：下文「未做」项仅指**编辑器 UI**，不代表 runtime / JSON 能力缺失。
