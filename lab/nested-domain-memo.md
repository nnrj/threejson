...
关联文档：[`domains/BUSINESS_DOMAINS_ZH.md`](../domains/BUSINESS_DOMAINS_ZH.md)、[`docs/zh/domains.md`](../docs/zh/domains.md)、[`examples/html-demo/track-05-tooling/05-02-nested-domain.html`](../examples/html-demo/track-05-tooling/05-02-nested-domain.html)
