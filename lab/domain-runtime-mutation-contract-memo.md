...
关联：[`doc/domains.md`](../doc/domains.md)、[`core/BUSINESS_DOMAINS.md`](../core/BUSINESS_DOMAINS.md)、[`core/runtime/objectMutation/`](../core/runtime/objectMutation/)、拟议 `core/runtime/sceneObjectCommands.js`

与 [`doc/scope.md`](../doc/scope.md) 无发布承诺。
...
| `userData.objJson` | 规范真源（canonical descriptor）；与 [`design-principles`](../doc/design-principles.md) 一致 |
...
写入 [`doc/domains.md`](../doc/domains.md) 时建议包含：
...
应用层（模型面板、`addToScene` 白名单等）属**产品配置**，不在 `doc/domains.md` 必选 API。
