...
本页**不代表发布承诺**；与 [`doc/scope.md`](../doc/scope.md) 的 Core 承诺区分。
...
| **文档** | [`core/ai/SKILL.md`](../core/ai/SKILL.md)、[`doc/api.md`](../doc/api.md) 与示例页 — **2026-06 AI Skill 对齐已落地**；见 [archive/ai-skill-gap-matrix.md](./archive/ai-skill-gap-matrix.md)。 |
