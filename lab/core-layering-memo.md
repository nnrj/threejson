...
**关联**：[doc/design-principles.md](../doc/design-principles.md)（理想职责简述）、[doc/scope.md](../doc/scope.md)（Canonical vs Runtime overlay）、[domain-runtime-mutation-contract-memo.md](./domain-runtime-mutation-contract-memo.md)、[core/runtime/objectMutation/](../core/runtime/objectMutation/)
...
对外稳定面仍是 [`core/index.js`](../core/index.js) 与 [`doc/api.md`](../doc/api.md) 的 **能力名**，而非目录名。
...
- 在 [design-principles.md](../doc/design-principles.md) 说明理想三层（**已完成索引**）
...
- 文档：`doc/api.md` § runtime-mutation、§ sceneObjectCommands
