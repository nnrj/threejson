...
**前置条件**：`html-demo` 仅需静态 HTTP；`vue-app` / `react-app` / `electron-apps` / `script` 需 **Node.js ≥ 24**（见 [`doc/development.md`](../doc/development.md)）。
...
完整列表见 [`demo.html`](../demo.html) 与 [`doc/tutorial.md`](../doc/tutorial.md)。
